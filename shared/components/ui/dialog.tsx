...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/* Centering lives on this wrapper, not on Content: a translate on Content
        would fight the enter/exit keyframes and make the dialog fly in from a
        corner (Tailwind v4 sets `translate`, the keyframes set `transform`). */}
