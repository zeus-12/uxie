...
const IndividualFlashcard = ({
  ...
  // TODO(desktop-ipc): wire real evaluation. Web used experimental_useObject → /api/evaluate.
  // The desktop should stream feedback over IPC and feed it back via `feedback`/`isEvaluating`.
      ...
      <div className="flex-grow overflow-auto">
        {hasAttempted ? (
          ...
          <IndividualFlashcardQuestion
            attempts={attempts}
            setCompletion={() => {}}
            complete={(prompt: string) => onEvaluate(prompt)}
            question={question}
            answer={answer}
            toggleAttempt={toggleAttempt}
            userResponse={userResponse}
