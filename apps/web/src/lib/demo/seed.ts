...
// Greeting shown at the top of the demo chat thread.
export const DEMO_CHAT_WELCOME = `Welcome to **Uxie**! I'm here to assist you. Feel free to ask questions or discuss topics based on the data provided.`;
